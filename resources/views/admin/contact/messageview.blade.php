...
<div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      ...
      <a class="breadcrumb-item " href="{{ route('message.index') }}">contact message</a>
              ...
              <div class="col-lg-12">
                <table class="table table-bordered" id="product_table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td> <strong>Created At : </strong> {{ $contactmessage->created_at }}</td>
                      </tr>
                      <tr>
                        <td> <strong>Email : </strong> {{ $contactmessage->email }}</td>
                      </tr>
                      <tr>
                        <td> <strong>Phone : </strong> {{ $contactmessage->phone }}</td>
                      </tr>
                      <tr>

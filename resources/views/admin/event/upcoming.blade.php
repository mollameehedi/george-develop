                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('event.move', $event->id) }}" class="btn btn-success">Active</a>
                                    <br>
                                    <a href="{{ route('event.update', $event->id) }}" class="btn btn-info">Update</a>
                                    <br>
                ...
                <div class="col-lg-4">
                    ...
                    <form method="POST" action="{{ route('event.store') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="event_name" placeholder="Enter your Event Name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="time" class="form-control" name="door_open" value="13:45:00">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputEmail1">Show Start</label>
                          <input type="time" class="form-control" name="show_start" value="14:45:00">
                        </div>
                        <div class="form-group">
